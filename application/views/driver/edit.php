        ...
        <div class="col-md-8 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php echo form_open_multipart('driver/edit/'.(isset($driver->id) ? $driver->id : '')); ?>
                        <?php if ($this->session->userdata('role') === 'admin'): ?>
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="vendor_id" name="vendor_id" required>
                                    ...
                                    ?>
                                        <option value="<?php echo $vendor->id; ?>" <?php echo ($driver->vendor_id == $vendor->id) ? 'selected' : ''; ?>>
                        ...
                        <div class="mb-3">
                            <label for="license_document" class="form-label">License Document (optional)</label>
                            ...
                            <?php if (!empty($driver->license_document) && file_exists('./uploads/drivers/' . $driver->license_document)): ?>
                                <div class="mt-2">
                        ...
                        <div class="mb-3">
                            <label for="photo" class="form-label">Driver Photo (optional)</label>
                            ...
                            <?php if (!empty($driver->photo) && file_exists('./uploads/drivers/' . $driver->photo)): ?>
                                <div class="mt-2 d-flex align-items-center">
                                    ...
                                    <img src="<?php echo base_url('uploads/drivers/' . $driver->photo); ?>" alt="Driver Photo" class="img-thumbnail" style="width: 100px; height: 100px; object-fit: cover;" onerror="this.onerror=null; this.src='<?php echo base_url('assets/images/no-image.png'); ?>';">
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="experience" name="experience" min="0" max="50" value="<?php echo $driver->experience_years; ?>" required>
                            <?php echo form_error('experience', '<div class="text-danger">', '</div>'); ?>
                        </div>
                        
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="is_active" name="is_active" value="1" <?php echo (isset($driver->is_active) && $driver->is_active) ? 'checked' : ''; ?>>
